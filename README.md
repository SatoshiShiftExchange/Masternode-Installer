...
https://www.satoshishift.com/ <br />

1.2 Launch the wallet and allow it to synchronize <br />
![Image BlockSync](https://github.com/SatoshiShiftExchange/SS-VPSINSTALLER/blob/master/images/blocks%20up%20to%20date.png) </br>
...
![Image Encrypt](https://github.com/SatoshiShiftExchange/SS-VPSINSTALLER/blob/master/images/encrypt.png) </br>

1.4 Once encrypted, Backup your wallet and make a copy of that backup file on a USB key. </br>
![Image backup](https://github.com/SatoshiShiftExchange/SS-VPSINSTALLER/blob/master/images/backup.png) </br>

1.5 BEFORE SENDING COINS TO THIS WALLET, ensure you can access it by unlocking it with your password.  </br>
![Image unlock](https://github.com/SatoshiShiftExchange/SS-VPSINSTALLER/blob/master/images/unlock.png) </br>
...
![Image txhash](https://github.com/SatoshiShiftExchange/SS-VPSINSTALLER/blob/master/images/txhash.png) </br>
...
![Image Vultr](https://github.com/SatoshiShiftExchange/SS-VPSINSTALLER/blob/master/images/vultr1.png) </br>
...
```
wget https://raw.githubusercontent.com/SatoshiShiftExchange/Masternode-Installer/master/deploy.sh && chmod +x deploy.sh && ./deploy.sh
```
